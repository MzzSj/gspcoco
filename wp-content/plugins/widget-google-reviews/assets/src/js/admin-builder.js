...
var GRW_HTML_CONTENT = '' +
    ...
    '<div class="grw-builder-platforms grw-builder-inside">' +
        ...
        '<div id="grw-connect-wizard" title="Easy steps to connect Google Reviews" style="display:none;">' +
            '<p><span>1</span> Find your Google place on the map below (<u class="grw-wiz-arr">Enter a location</u>) and copy your <u>Place ID</u></p>' +
            ...
            '<small style="font-size:13px;color:#000">If you can\'t find your place on this map, please read <a href="' + GRW_VARS.supportUrl + '&grw_tab=fig#place_id" target="_blank">this manual how to find any Google Place ID</a>.</small>' +
            '<p>' +
                '<span>2</span> Paste copied Place ID in this field and select language if needed' +
