  ...
  methods: {
    ...
    updateSettings (entitySettingsJson) {
      ...
      if (this.$root.clonedSettings.payments.wc.enabled === false && this.$root.clonedSettings.payments.mollie.enabled === false && entitySettingsJson !== null) {
        ...
        if (('onSite' in entitySettings.payments && !entitySettings.payments.onSite) &&
          ('payPal' in entitySettings.payments && !entitySettings.payments.payPal.enabled) &&
          ('stripe' in entitySettings.payments && !entitySettings.payments.stripe.enabled) &&
          ('mollie' in entitySettings.payments && !entitySettings.payments.mollie.enabled) &&
          ('razorpay' in entitySettings.payments && !entitySettings.payments.razorpay.enabled)
        ) {
