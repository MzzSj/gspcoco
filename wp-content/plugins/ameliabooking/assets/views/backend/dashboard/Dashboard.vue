<template>
  <div class="am-wrap">
    ...
    <transition name="fade" id="am-lite-promo">
      <div
        v-if="$root.settings.activation.enableAmeliaPromoBanner && promoBannerEnabled"
        class="am-promo-banner"
        :style="{backgroundImage: `url(${$root.getUrl + 'public/img/am-promo-banner-liteautumn.svg'})`}"
      >
        <div class="am-promo-banner__content">
          <div class="am-promo-banner__left">
            <img :src="$root.getUrl + 'public/img/am-promo-banner-liteautumn-text.svg'" alt="Autumn Sale">
          </div>
          <div class="am-promo-banner__center">
              <span>
                GET UP TO
              </span>
              <span>
          ...
          <p class="am-promo-banner__close" @click="removeAmeliaLiteBanner">
            {{ $root.labels.not_show }}<img :src="$root.getUrl + 'public/img/am-close-x.svg'" alt="Close">
          </p>
    ...
    methods: {
      ...
      getDashboardOptions () {
        this.fetchEntities((success) => {
          ...
          types: !AMELIA_LITE_VERSION ? ['categories', 'locations', 'employees', 'customers', 'custom_fields', 'packages', 'resources'] : ['categories', 'employees', 'customers'],
          page: 'appointments',
          isFrontEnd: false,
          isPanel: false
        })
...
.am-promo-banner {
  ...
  * {
  ...
  &__close {
    ...
    img {
      margin-left: 20px;
      background-color: rgba(255, 214, 1, 0.67);
      border-radius: 8px;
    }
  }
