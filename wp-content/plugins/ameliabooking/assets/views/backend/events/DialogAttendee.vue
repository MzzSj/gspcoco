    ...
    methods: {
      ...
      errorCallback (responseData) {
        ...
        setTimeout(function () {
          ...
          } else if ('timeSlotUnavailable' in responseData.data && responseData.data.timeSlotUnavailable === true) {
            $this.notify($this.$root.labels.error, $this.$root.labels.maximum_capacity_reached, 'error')
          }

          if ('couponUnknown' in responseData && responseData.couponUnknown === true) {
