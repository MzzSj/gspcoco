  ...
  export default {
    ...
    methods: {
      ...
      getParsedEntity (createPaymentLinks) {
        ...
        if (this.packageCustomer !== null) {
          this.appointment.bookings.forEach((bookItem) => {
            ...
            let packageCustomerService = this.packageCustomer.data.find(i => i.serviceId === this.appointment.serviceId)
            ...
            let bookingData = {
              ...
              packageCustomerService: {
                id: packageCustomerService.bookings[0].id,
              },
              utcOffset: null,
            }
      ...
      handleCustomerChange () {
        ...
        if (this.mounted && ((this.options.entities.resources && this.options.entities.resources.length > 0) || duration !== this.appointment.duration)) {
          this.getTimeSlots(this.updateCalendar)
        }
      ...
      handleBookingChange () {
        ...
        if ((this.options.entities.resources && this.options.entities.resources.length > 0) || duration !== this.appointment.duration) {
          this.getTimeSlots(this.updateCalendar)
        }
      },
