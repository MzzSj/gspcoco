  ...
  <div>
    <div class="am-dialog-scrollable">
      ...
      <el-form :model="settings" ref="settings" :rules="rules" label-position="top" @submit.prevent="onSubmit">
        ...
        <!-- Payment Links -->
        <el-popover :disabled="!$root.isLite" ref="paymentLinksPop" v-bind="$root.popLiteProps"><PopLite/></el-popover>
        <div class="am-setting-box am-switch-box" v-popover:paymentLinksPop :class="{'am-lite-disabled': ($root.isLite)}">
          <el-row type="flex" align="middle" :gutter="24">
            <el-col :span="16">
