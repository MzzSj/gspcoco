      ...
      <el-form :model="service" ref="service" :rules="rulesService" label-position="top">
        <el-tabs v-model="serviceTabs">
          ...
          <el-tab-pane :label="$root.labels.details" name="service_details">
            ...
            <div class="am-setting-box am-switch-box">
              <el-popover :disabled="!$root.isLite" ref="limitPerCustomerPop" v-bind="$root.popLiteProps"><PopLite/></el-popover>
              <el-row v-popover:limitPerCustomerPop type="flex" align="middle" :gutter="24">
                <el-col :span="19" :class="{'am-lite-disabled': ($root.isLite)}">
                ...
                <el-col :span="5" class="align-right">
                  <el-switch v-model="service.limitPerCustomer.enabled" :disabled="$root.isLite"></el-switch>
                </el-col>
              </el-row>
  ...
  export default {
    ...
    methods: {
      ...
      getParsedEntity: function (applyGlobally) {
        ...
        return Object.assign(JSON.parse(JSON.stringify(this.service)), {settings: null, customPricing: null, limitPerCustomer: null})
      },
