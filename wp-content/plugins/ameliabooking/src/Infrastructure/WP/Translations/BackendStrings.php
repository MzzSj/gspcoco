...
%company_name%'),
    ...
    public static function getWhatsNewStrings()
    {
        return [
            ...
            'current_version'                => __('You are currently using our Lite Free version ', 'wpamelia'),
            'version'                        => __('Version ', 'wpamelia'),
            'version_subtitle'               => __('We are thrilled to announce the latest release of Amelia Premium version. Below, you can find the latest features and improvements.', 'wpamelia'),
     ...
     * @return array
     */
    public static function getLiteVsPremitumStrings()
    {
        return [
