...
class UpdateSettingsCommandHandler extends CommandHandler
{
    ...
    public function handle(UpdateSettingsCommand $command)
    {
        ...
        $settingsFields['activation'] = array_merge(
            ...
            isset($settingsFields['activation']['enableAmeliaPromoBanner']) ? [
                'enableAmeliaPromoBanner' => $settingsFields['activation']['enableAmeliaPromoBanner']
            ] : [],
            isset($settingsFields['activation']['enableAmeliaQAPromoBanner']) ? [
                'enableAmeliaQAPromoBanner' => $settingsFields['activation']['enableAmeliaQAPromoBanner']
            ] : [],
