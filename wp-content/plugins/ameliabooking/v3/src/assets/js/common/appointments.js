...
import {sortForEmployeeSelection} from "./employee";
  ...
  if (!cartItem.packageId &&
    ...
    Object.keys(cartItem.services).forEach((serviceId) => {
      if (cartItem.services[serviceId].list.length &&
        ...
        setPreferredEntitiesData(cartItem.services[serviceId], store, serviceId)
      }
    })
  }
...
function setPreferredEntitiesData (bookings, store, serviceId) {
