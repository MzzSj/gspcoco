...
function useFilteredProviders (store) {
  ...
  let preselectedEmployee = store.getters['entities/getPreselected'].employee

  let employees = preselectedEmployee ? store.getters['entities/getUnfilteredEmployees'].filter(a => a.id === parseInt(preselectedEmployee)) : store.getters['entities/getUnfilteredEmployees']
...
function useFilteredLocations (store) {
  ...
  let preselectedLocation = store.getters['entities/getPreselected'].location

  let locations = preselectedLocation ? store.getters['entities/getUnfilteredLocations'].filter(a => a.id === parseInt(preselectedLocation)) : store.getters['entities/getUnfilteredLocations']
