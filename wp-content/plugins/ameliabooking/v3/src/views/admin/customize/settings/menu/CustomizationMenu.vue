...
let serviceAppointmentArray = ref([
  {
...
if (licence.isLite) {
  serviceAppointmentArray.value.splice(4, 1)
  serviceAppointmentArray.value.splice(3, 1)
  serviceAppointmentArray.value.splice(1, 1)
}
...
if (pageRenderKey.value === 'cbf' && (licence.isBasic || licence.isLite)) {
