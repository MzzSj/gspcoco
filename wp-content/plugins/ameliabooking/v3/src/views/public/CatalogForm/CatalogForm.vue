...
function setShortcodeParams () {
  ...
  if (shortcodeData.value.categories_hidden && !shortcodeData.value.category) {
    availableCategories.value = JSON.parse(JSON.stringify(useAvailableCategories(amEntities.value)))
